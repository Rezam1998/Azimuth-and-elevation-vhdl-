...
set rc [catch {
  ...
  add_files -quiet {{D:/Projects/probation training/cordic_Azimuth/cordic_Azimuth.runs/synth_1/Top_module.dcp}}
  ...
  link_design -top Top_module -part xc7a200tfbg484-2
